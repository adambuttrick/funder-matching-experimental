...
def calculate_match(row):
    if row['predicted_funder_ids'] and row['funder_id'] in row['predicted_funder_ids']:
        return 'Y'
    elif row['predicted_funder_ids'] and row['funder_id'] not in row['predicted_funder_ids']:
        return 'N'
    elif not row['predicted_funder_ids'] and row['funder_id'] == 'NP':
        return 'TN'
    else:
        return 'NP'
